...
{
    public class PriceVolumeAlgo : QCAlgorithm
    {
        [Parameter("symbols")]
        ...
        private string _netIncome = null;
        ...
        public string NetIncome { get => _netIncome; set => _netIncome = value; }
        ...
        public override void Initialize()
        {
            ...
            SetWarmUp((int)(1.1 * Math.Max(period, turnoverPeriod)), Resolution.Daily);
            SetAlpha(new MultiSignalAlpha(InsightDirection.Up, resolution, symbols,
                (symbol) => new TurnoverSignal(period, turnover),
                (symbol) => new FundamentalSignal(
                    ...
                    peRatio: _peRatio,
                    epRatio: _epRatio),
                (symbol) => new PriceVolumeSignal(period)));
        }
