...
{
    public class StochasticsAlgo : QCAlgorithm
    {
        [Parameter("symbols")]
        ...
        public override void Initialize()
        {
            ...
            SetPortfolioConstruction(new SlotPortfolio(
                ...
                reinvest: reinvest,
                rebalance: rebalance,
                smaPeriod1: trackerPeriod1 >= 0 ? trackerPeriod1 : period,
                smaPeriod2: trackerPeriod2 >= 0 ? trackerPeriod2 : period,
            ...
            SetAlpha(new MultiSignalAlpha(InsightDirection.Up, resolution, hold, symbols,
                (symbol) => new FundamentalSignal(
                    ...
                    peRatio: _peRatio,
                    epRatio: _epRatio),
                (symbol) => new StochasticsSignal(this, symbol, resolution, period)));
        }
