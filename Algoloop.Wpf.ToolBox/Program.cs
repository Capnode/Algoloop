...
using Algoloop.Wpf.ToolBox.DukascopyDownloader;
using Algoloop.Wpf.ToolBox.MetastockConverter;
...
namespace Algoloop.Wpf.ToolBox
{
    public class Program
    {
        private const string ApplicationName = "Algoloop.Wpf.ToolBox.exe";
